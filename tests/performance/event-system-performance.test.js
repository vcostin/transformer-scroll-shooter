...
describe('Event System Performance', () => {
    ...
    describe('Event Listener Management', () => {
        it('should efficiently manage large numbers of listeners', () => {
            ...
            const addResults = profiler.benchmark('addListeners', () => {
    ...
    describe('State Management Performance', () => {
        it('should update state efficiently', () => {
            ...
            const results = profiler.benchmark('stateUpdates', () => {
        ...
        it('should handle state subscriptions efficiently', () => {
            ...
            const results = profiler.benchmark('stateNotifications', () => {
    ...
    describe('Real-world Performance Scenarios', () => {
        it('should handle game menu interactions at 60fps', () => {
            ...
            for (let frame = 0; frame < 600; frame++) { // 10 seconds at 60fps
                ...
                if (frame > 60) { // Allow initial frames to warm up
