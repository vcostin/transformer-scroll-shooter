...
describe('Event-Driven Game Loop', () => {
  ...
  describe('Game Loop Architecture', () => {
    ...
    it('should not emit game:update when paused', () => {
      ...
      expect(eventSpy).not.toHaveBeenCalledWith(GAME_EVENTS.GAME_UPDATE, expect.any(Object))
    })
  ...
  describe('Event Listener Management', () => {
    it('should register core game event listeners', () => {
      ...
      expect(mockEffect).toHaveBeenCalledWith(GAME_EVENTS.GAME_START, expect.any(Function))

      expect(mockEffect).toHaveBeenCalledWith(GAME_EVENTS.GAME_PAUSE, expect.any(Function))

      expect(mockEffect).toHaveBeenCalledWith(GAME_EVENTS.GAME_RESUME, expect.any(Function))
    })
  ...
  describe('Integration with State Management', () => {
    it('should update state when game events occur', () => {
      ...
      expect(mockSetState).toHaveBeenCalledWith('game.state', 'running')
    })
