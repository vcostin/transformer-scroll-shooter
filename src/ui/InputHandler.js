...
import { UI_EVENTS, INPUT_ACTIONS, UI_STATE_KEYS } from '@/constants/ui-events.js'
...
export class InputHandler {
  ...
  addToBuffer(input) {
    ...
    // Clear old entries
    const now = Date.now()
    this.inputBuffer = this.inputBuffer.filter(entry => now - entry.timestamp < this.bufferTimeout)
  }
