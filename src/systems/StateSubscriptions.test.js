...
describe('StateSubscriptions', () => {
    ...
    describe('Unsubscribe Method', () => {
        ...
        it('should perform O(1) unsubscribe using index optimization', () => {
            ...
            const unsubscribers = callbacks.map(cb => 
                stateSubscriptions.subscribe('player.health', cb)
            );
    ...
    describe('Trigger Subscriptions', () => {
        ...
        it('should handle nested path subscriptions correctly', () => {
            ...
            expect(positionCallback).toHaveBeenCalledWith(mockState.player.position, undefined, 'player.position');
    ...
    describe('Debug Logging', () => {
        ...
        it('should log clear all operations', () => {
            ...
            expect(console.log).toHaveBeenCalledWith(
                '🗑️ StateSubscriptions: All subscriptions cleared'
            );
        });
