...
describe('EffectManager', () => {
  ...
  describe('start()', () => {
    it('should start effect manager and hook into event dispatcher', () => {
      ...
      expect(mockEventSystems.eventDispatcher.on).toHaveBeenCalledWith(
        'game:cleanup',
        expect.any(Function)
      )
      expect(mockEventSystems.eventDispatcher.on).toHaveBeenCalledWith(
  ...
  describe('stop()', () => {
    it('should stop effect manager and restore original emit', () => {
      ...
      expect(mockEventSystems.eventDispatcher.off).toHaveBeenCalledWith(
        'game:cleanup',
        expect.any(Function)
      )
      expect(mockEventSystems.eventDispatcher.off).toHaveBeenCalledWith(
  ...
  describe('_triggerEffects()', () => {
    ...
    it('should handle effects that throw errors', async () => {
      ...
      expect(effectManager._originalEmit).toHaveBeenCalledWith(
