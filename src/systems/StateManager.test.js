...
describe('StateManager', () => {
  ...
  describe('setState() method', () => {
    ...
    it('should throw error for invalid path', () => {
      expect(() => testStateManager.setState('', 'value')).toThrow(
        'State path must be a non-empty string'
      )
      expect(() => testStateManager.setState(null, 'value')).toThrow(
        'State path must be a non-empty string'
      )
    })
  ...
  describe('State validation', () => {
    ...
    it('should validate data types', () => {
      expect(() => testStateManager.setState('player.health', 'invalid')).toThrow(
        'Validation error'
      )
      expect(() => testStateManager.setState('game.paused', 'not_boolean')).toThrow(
        'Validation error'
      )
    })
  ...
  describe('subscribe() method', () => {
    ...
    it('should throw error for invalid callback', () => {
      expect(() => testStateManager.subscribe('player.health', 'not_function')).toThrow(
...
describe('State Schema Integration', () => {
  ...
  describe('Async state management', () => {
    it('should handle async state updates with setStateAsync', async () => {
      const asyncValue = new Promise(resolve => setTimeout(() => resolve(75), 10))
    ...
    it('should handle loading states during async operations', async () => {
      const asyncValue = new Promise(resolve => setTimeout(() => resolve(90), 20))
    ...
    it('should handle async errors with error states', async () => {
      ...
      await expect(
        testStateManager.setStateAsync('player.health', asyncError, {
          loadingPath: 'ui.loading',
          errorPath: 'ui.error'
        })
