...
import { Effect, Explosion, PowerupEffect, MuzzleFlash, TrailEffect, TransformEffect } from '@/rendering/effects.js';
...
describe('Effects System', () => {
    ...
    describe('TransformEffect', () => {
        ...
        it('should update particles and rings', () => {
            ...
            const hasMovingParticles = transform.particles.some(p => Math.abs(p.vx) > 0 || Math.abs(p.vy) > 0);
        ...
        it('should remove dead particles and rings', () => {
            ...
            transform.particles.forEach(particle => { particle.life = -1; });
            transform.rings.forEach(ring => { ring.life = -1; });
