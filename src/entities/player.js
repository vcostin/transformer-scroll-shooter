...
export default class Player {
  ...
  update(deltaTime, keys) {
    ...
    this.eventDispatcher.emit(PLAYER_EVENTS.PLAYER_SHOOT_COOLDOWN_CHANGED, {
      value: this.shootCooldown
    })
    this.eventDispatcher.emit(PLAYER_EVENTS.PLAYER_TRANSFORM_COOLDOWN_CHANGED, {
      value: this.transformCooldown
    })
